...
const Expense = () => {
  ...
  const handleCancel = () => {
    setShowModal(false);
    showToast('ຍົກເລີກການເພີ່ມລາຍຈ່າຍ', 'info');
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ แสดง Toast สำเร็จ
      showToast('ບັນທຶກລາຍຈ່າຍສຳເລັດ!', 'success');
  ...
  return (
    <div className="min-h-screen relative">
      <Header 
        title="ລາຍຈ່າຍ" 
        subtitle="ເບິ່ງ ແລະ ຈັດການລາຍຈ່າຍຂອງທ່ານ"
      />
      
      <main className="p-8">
        {/* Card ລວມ Filter + ປຸ່ມເພີ່ມ */}
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-slate-100 bg-slate-50/50 rounded-t-2xl">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-slate-800">ເພີ່ມລາຍຈ່າຍ</h2>
                </div>
                <button
                  onClick={() => setShowModal(false)}
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-12 border border-slate-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none transition-all text-lg font-semibold"
                      placeholder="0.00"
                    />
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none transition-all bg-white"
                  >
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 px-4 py-3 bg-rose-500 hover:bg-rose-600 text-white rounded-xl font-medium transition-colors shadow-lg shadow-rose-500/30"
                  >
                    ບັນທຶກ
                  </button>
                </div>
